...
// Seletores para os novos elementos HTML
        ...
        summaryDiv.innerHTML = `
            <div style="display: flex; gap: 20px; flex-wrap: wrap; justify-content: center;">
                <div class="summary-card">
                    ...
                    <hr>
                    <p class="detail-value active-revenue"><strong>(+) Ativos:</strong> R$ ${summary.receitaBruta.toFixed(2)}</p>
                    <p class="detail-value refund-revenue"><strong>(-) Estornos:</strong> R$ ${summary.totalEstornos.toFixed(2)}</p>
                </div>
                <div class="summary-card">
